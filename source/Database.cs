...
namespace VK_Unicorn
{
    class Database
    {
        ...
        public class Settings
        {
            ...
            {
                /// <summary>
                /// Все пользователи из закрытых сообществ, остальные по городу, включая закрытые профили
                /// </summary>
                SMART,
                /// <summary>
                /// Только те пользователи, у которых указан твой город, включая закрытые профили
                /// </summary>
                BY_CITY,
                /// <summary>
