...
namespace VK_Unicorn
{
    class Timeouts
    {
        ...
        /// Торопиться некуда, лучше сканировать немного медленно, но зато без угрозы бана аккаунта
        ...
        /// но мы будем сканировать немного реже, опять же чтобы снизить угрозу бана аккаунта или появления капчи.
